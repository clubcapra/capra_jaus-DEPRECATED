...
class Resume(JausMessage):
    ...
    def execute(self):
        rospy.logdebug('Receiving command RESUME from %s', self.source_id)
        ...
        if is_controlling_client:
            ...
            rospy.logwarn("The client isn't controlling the robot, the command RESUME will be ignored.")
